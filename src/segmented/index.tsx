...
import { Segmented as RcSegmented } from './Segmented';
...
export type { SegmentedValue } from './types';
...
export const Segmented = React.forwardRef<HTMLDivElement, SegmentedProps>((props, ref) => {
  const {
